...
int __FASTERJSON_VERSION_1_1_8 = 0 ;

#define FASTERJSON_TOKEN_EOF		-1
#define FASTERJSON_TOKEN_LBB		0x1	/* { */
#define FASTERJSON_TOKEN_RBB		0x2	/* } */
#define FASTERJSON_TOKEN_LSB		0x3	/* [ */
#define FASTERJSON_TOKEN_RSB		0x4	/* ] */
#define FASTERJSON_TOKEN_COLON		0x5	/* : */
#define FASTERJSON_TOKEN_COMMA		0x6	/* , */
#define FASTERJSON_TOKEN_TEXT		0x7

#define FASTERJSON_TOKEN_TRUE		0x11
#define FASTERJSON_TOKEN_FALSE		0x12
#define FASTERJSON_TOKEN_NULL		0x21
	...
	, void *p , char *array_nodename , int array_nodename_len )
{
	...
	while(1)
	{
		...
		if( tag == FASTERJSON_TOKEN_TEXT || (tag>>4) )
		{
			if( quotes == '\'' )
				return FASTERJSON_ERROR_JSON_INVALID_ON_TOKEN_LEAF_1;
			content = begin ;
			if( tag == FASTERJSON_TOKEN_NULL )
				content = "\x7F" ;
			content_len = len ;
