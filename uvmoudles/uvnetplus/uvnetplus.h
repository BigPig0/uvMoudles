...
public:
    ...
    static CTcpClient* Create(CNet* net, fnOnTcpEvent onReady);
    virtual void Delete() = 0;
    virtual void Connect(std::string strIP, uint32_t nPort, fnOnTcpEvent onConnect) = 0;
...
public:
    ...
    static CTcpServer* Create(CNet* net, fnOnTcpConnection onConnection);
    virtual void Delete() = 0;
