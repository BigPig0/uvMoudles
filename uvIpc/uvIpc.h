 ...
 * @param len 消息内容长度
 */
typedef void (*uv_ipc_recv_cb)(char* name, char* msg, char* data, int len);
 ...
 * @param cb 接收到消息的回调方法
 */
_UV_IPC_API int uv_ipc_client(uv_ipc_handle_t** h, char* ipc, void* uv, char* name, uv_ipc_recv_cb cb);
